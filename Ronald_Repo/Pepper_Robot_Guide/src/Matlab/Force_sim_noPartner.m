...
%goalTraj=   [2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00  2.00; 
...
parTraj=    [0.00  0.02  0.03  0.02  0.01  0.00 -0.01  0.00  0.02  0.03  0.02  0.01  0.00 -0.01  0.00  0.01  0.00 -0.01  0.00  0.02  0.03 -0.01  0.00; 
            -0.60 -0.61 -0.60 -0.60 -0.59 -0.58 -0.59 -0.60 -0.61 -0.60 -0.60 -0.59 -0.58 -0.59 -0.59 -0.59 -0.58 -0.59 -0.60 -0.61 -0.60 -0.60 -0.61];
...
%     end
    ...
    Fpax = linspace(0,mag*Fparx,points);
    Fpay = linspace(0,mag*Fpary,points);
...
%    Fpa = plot(Fpax,Fpay,'-g','LineWidth',2);
    ...
    lhandle = legend([Fto Fgo Fpe], ...
        'Total Force','Sub-goal Force','Pedestrian Force');
